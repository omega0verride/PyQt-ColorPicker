...
class defaultColors(QWidget):
    def __init__(self, colorpickerWidget, parent=None):
        ...
        self.spaceForSeconfRow = int(self.buttonsWidht / 2)
...
class colorpickerWheel(QWidget):
    def __init__(self, colorpickerSize, startupcolor, mouseDot_size, mouseDotDistance_changer, centralColorWidget_size,
        ...
        self.colorPickerHueWheelImageWdiget = QLabel()
        ...
        self.centerColorWidget = QLabel(parent=self.colorPickerHueWheelImageWdiget)
        ...
        self.mouseDot = QLabel(parent=self.colorPickerHueWheelImageWdiget)
    ...
    def mousePressEvent(self, q_mouse_press_event: QMouseEvent):
        mouse_position = q_mouse_press_event.globalPosition()
        x = mouse_position.x() - self.width / 2
        y = mouse_position.y() - self.height / 2
        if y == 0 and x < 0:
            angle = 270
        elif y == 0 and x > 0:
            angle = 90
